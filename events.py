...
def scrape_events(base_url):
    ...
    if base_url in [movie, platzhirsch, irish_pub]:
        if base_url == movie:
            add_recurring_events(events, "Salsa Party (@movie_liveclub)", "THURSDAY", movie, 'weekly', None, '20:00', 'Party',"https://www.tampham.co/content/images/size/w1460/2023/03/DSC06014.JPEG")
